...
public class IslandLevel extends RDCommand {

    protected IslandLevel() {
        super("level");
    }

    @Override
    protected void handleCommand(Player player, String[] args) throws CommandException {
        SkyPlayer skyPlayer = SkyBlock.getPlugin().getPlayerRegistry().getPlayer(player.getName());
    ...
    public boolean isIslandLevelBlock(Block block) {
    ...
    public int handleBlock(List<Block> blocks) {
